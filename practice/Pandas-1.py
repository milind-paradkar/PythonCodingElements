...
df_good_names_less_cols = df_good_names.drop(['Country_changed', 'Year_changed'], axis=1)  # Trying to drop a column, but not successful
...
df_goodnames_less_col_list = df_good_names.drop(['Country_changed', 'Year_changed'],
                                                axis=1)  # inplace is NOT used, so original remains same, but new df is created.
prln(df_goodnames_less_col_list)
df_goodnames_less_col_list = df_good_names.drop(['Country_changed', 'Year_changed'], axis=1,
